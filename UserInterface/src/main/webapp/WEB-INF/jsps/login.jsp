		...
		<div class="shadow-none p-3 mb-5 rounded">
			<form:form method="POST" modelAttribute="user">
				...
				<div class="form-group input-group px-5">
					<div class="input-group-text input-group-append my-4 ">
						<span class="material-icons"> account_circle </span>
					</div>
					<input type="text" name="username" class="form-control my-4 p-4" placeholder="User name">
				</div>
				...
				<div class="form-group input-group px-5">
					...
					<input type="password" name="password" class="form-control p-4" placeholder="Enter the Password">
				</div>
