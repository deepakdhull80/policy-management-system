														...
														<table class="table table-hover w-50 ">
															...
															<% for (BusinessDetails bs : consumer.getBusiness()) { %>
																...
																<tr>
																	...
																	<td>
																		<%=bs.getBusinessTurnOver()%>
																	</td>
																</tr>
																<tr>
																	<th>Capital Investment</th>
																	<td>
																		<%=bs.getCapitalInvested()%>
																	</td>
																</tr>
																<tr>
																	<th>Total Employee</th>
																	<td>
																		<%=bs.getTotalEmployees()%>
																	</td>
																</tr>
																<tr>
																	<th>Business Age</th>
																...
																<% for (PropertyDetails pr : bs.getProperty()) { %>
																	...
																	<tr>
																		...
																		<td>
																			<%=pr.getCostOfTheAsset()%>
																		</td>
																	</tr>
																	<tr>
																		<th>Usefull Life Of The Assets</th>
																		<td>
																			<%=pr.getUsefulLifeOfTheAsset()%>
																		</td>
																	</tr>
																	<tr>
																		<th>Salvage Value</th>
														...
														<div class="modal-dialog" role="document">
															<div class="modal-content">
																<div class="modal-header">
																	<h5 class="modal-title" id="createBPLabel">Create
																		Business
																		And Property</h5>
																...
																<div class="modal-body">
																	<form action="/issue-policy" modelAttribute="detail"
																		...
																		<div class="modal-body">
																			...
																			<div class="form-group">
																				<label for="businessId">Policy Unique
																					Id</label> <input type="number"
																					name="uniqueId" class="form-control"
																...
																<form action="/create-policy" modelAttribute="detail"
																	...
																	<div class="modal-body">
																		<div class="form-group">
																			...
																			<input type="number" name="consumerId"
																				class="form-control"
																		...
																		<div class="form-group">
																			...
																			<input type="number" name="businessId"
																				class="form-control"
